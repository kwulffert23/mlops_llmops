...
Opening a pull request will trigger a[workflow](../.github/workflows/mlops_llmops-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/staging/mlops_llmops/mlops_llmops-model)
* [Prod model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/prod/mlops_llmops/mlops_llmops-model)
. 
