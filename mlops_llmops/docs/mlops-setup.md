...
git add README.md docs .gitignore mlops_llmops/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[mlops_llmops/databricks.yml](../mlops_llmops/databricks.yml) file.
...
Follow the instructions in [mlops_llmops/resources/README.md](../mlops_llmops/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../mlops_llmops/resources/README.md)  to propose, test, and deploy
